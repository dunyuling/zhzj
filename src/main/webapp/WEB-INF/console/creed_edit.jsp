            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" enctype="multipart/form-data"
                          method="post" action="/creed_edit.do">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">名称：</label>
                            <div class="col-sm-7">
                                <input type="hidden" value="${creed.id}" name="id" />
                                <input name="title" class="form-control" type="text" value="${creed.title}" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <textarea hidden id="content">${creed.content}</textarea>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input id="religionType_" type="hidden" value="${creed.religionType}">
