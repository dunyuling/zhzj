            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" enctype="multipart/form-data"
                          method="post" action="/information_edit.do">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">名称：</label>
                            <div class="col-sm-7">
                                <input name="id" value="${information.id}" type="hidden" />
                                <input name="title" value="${information.title}" class="form-control" type="text" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea name="content" class="form-control" type="text" required>${information.content}</textarea>
                            </div>
                        </div>
