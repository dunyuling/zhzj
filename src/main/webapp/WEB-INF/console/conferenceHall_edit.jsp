            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" enctype="multipart/form-data"
                          method="post" action="/conferenceHall_edit.do">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">名称：</label>
                            <div class="col-sm-7">
                                <input name="id" value="${conferenceHall.id}" type="hidden">
                                <input name="name" value="${conferenceHall.name}" class="form-control" type="text"
                                       required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input name="address" class="form-control" type="text" value="${conferenceHall.address}"
                                       required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="externalLinkZone" class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input name="externalLink" type="url" id="externalLink"
                                       value="${conferenceHall.externalLink}"
...
<script src="/js/inner/conferenceHall_edit.js"></script>
<!--统计代码，可删除-->
