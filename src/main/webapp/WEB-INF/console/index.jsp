            ...
            <ul class="nav" id="side-menu">
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a class="J_menuItem" href="profile.html">政府资讯管理</a>
                        </li>
                        <li><a class="J_menuItem" href="teams_board.html">宗教资讯管理</a>
                        </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            <li>
                                ...
                                </a>http://localhost:8080/login.do?username=admin&password=123456
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="profile.html">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                ...
                                <div class="media-body">
                                    ...
                                    <br>
                                    <small class="text-muted">http://localhost:8080/login.do?username=admin&password=123456昨天 2:45</small>
                                </div>
                            </a>
                        </div>
                        <div class="sidebar-message">
