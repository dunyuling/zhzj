            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" enctype="multipart/form-data"
                          method="post" action="/information_add.do">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">名称：</label>
                            <div class="col-sm-7">
                                <input name="title" class="form-control" type="text" required>
                                <input name="ip" value="${ip}" class="form-control" type="hidden" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea name="content" class="form-control" type="text" required></textarea>
                            </div>
                        </div>
